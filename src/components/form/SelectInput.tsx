      ...
      <div ref={dropdownRef} className={`relative ${containerClassName}`}>
        ...
        >
          <div className="flex items-center">
            ...
            <span className="ml-2">
              {value ? options.find((opt) => opt.value === value)?.label : "Pilih Disini"}
            </span>
        ...
        <div
          ref={bodyRef}
          className={`origin-top-right w-full shadow-solid scrollbar overflow-y-auto absolute z-30 left-0 mt-1 rounded shadow-lg transition-all duration-300 overflow-hidden ${
            isDefault ? "bg-white dark:bg-neutralHoverDark" : "bg-white dark:bg-neutralDark"
          } ${
